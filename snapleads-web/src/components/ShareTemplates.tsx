...
App is 100% safe - verified on VirusTotal:
...
App verified safe on VirusTotal:
Win: ${VT_SCAN_URL_WIN}
Mac: ${VT_SCAN_URL_MAC}
Linux: ${VT_SCAN_URL_LINUX}
...
The app is verified safe on VirusTotal:
Windows: ${VT_SCAN_URL_WIN}
macOS: ${VT_SCAN_URL_MAC}
Linux: ${VT_SCAN_URL_LINUX}
...
The application has been verified safe on VirusTotal:
Windows: ${VT_SCAN_URL_WIN}
macOS: ${VT_SCAN_URL_MAC}
Linux: ${VT_SCAN_URL_LINUX}
...
The app has been verified safe on VirusTotal:
Windows: ${VT_SCAN_URL_WIN}
macOS: ${VT_SCAN_URL_MAC}
Linux: ${VT_SCAN_URL_LINUX}
