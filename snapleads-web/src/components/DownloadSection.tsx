...
const DOWNLOAD_WIN = "https://s3.us-west-1.idrivee2.com/crop-spray-uploads/leads-cm-database/SnapLeads-Setup-3.5.12.exe";
const DOWNLOAD_MAC = "https://s3.us-west-1.idrivee2.com/crop-spray-uploads/leads-cm-database/SnapLeads-3.5.12-arm64-mac.zip";
const DOWNLOAD_LINUX = "https://s3.us-west-1.idrivee2.com/crop-spray-uploads/leads-cm-database/SnapLeads-3.5.12.AppImage";
const VERSION = "3.5.12";

type OSTab = "windows" | "macos" | "linux";

const VT_SCAN_URLS: Record<OSTab, string> = {
    windows: "https://www.virustotal.com/gui/file/3bb1adcbab44df0bc397fad1bf4a89c4793002441578399cb6a7e21dfe96325f",
    macos: "https://www.virustotal.com/gui/file/0e9757ca4bbd12fce3a5c38988ce93020cd49a1d7f259fd79cc9c883f5e50841",
...
const bypassGuides: BypassGuide[] = [
  ...
  },
  {
    ...
    steps: [
      "Download the .AppImage file to your desired location (e.g., ~/Applications/)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.12.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Run it: ./SnapLeads-3.5.12.AppImage",
  ...
  },
  {
    ...
    steps: [
      ...
      "For AppArmor: sudo aa-complain /path/to/SnapLeads-3.5.12.AppImage",
...
const installSteps: Record<OSTab, string[]> = {
  ...
  linux: [
    ...
    "Open Terminal and navigate to the download location",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.12.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Run it: ./SnapLeads-3.5.12.AppImage (or double-click if FUSE is installed)",
