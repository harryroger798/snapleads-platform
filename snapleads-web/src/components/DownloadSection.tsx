...
const DOWNLOAD_WIN = "https://f005.backblazeb2.com/file/snapleads-downloads/desktop/SnapLeads%20Setup%203.5.7.exe";
const DOWNLOAD_MAC = "https://f005.backblazeb2.com/file/snapleads-downloads/desktop/SnapLeads-3.5.7-arm64-mac.zip";
const DOWNLOAD_LINUX = "https://f005.backblazeb2.com/file/snapleads-downloads/desktop/SnapLeads-3.5.7.AppImage";
const VERSION = "3.5.7";

type OSTab = "windows" | "macos" | "linux";

const VT_SCAN_URLS: Record<OSTab, string> = {
    windows: "https://www.virustotal.com/gui/file/61761ddae4140502969fb18360e88c79ec83f6a5a4e26486a511dfdbd7ede131",
    macos: "https://www.virustotal.com/gui/file/720e940d05cfab332ffcfbcc8817b46a4d7f3759acfe714e836e8d7315b706bd",
    linux: "https://www.virustotal.com/gui/file/2fa0e8c9a112ec02298b770a24da5ad265911f01dfa0ca4cf64e46c235c33b2b",
};
...
const bypassGuides: BypassGuide[] = [
  ...
  },
  {
    ...
    steps: [
      "Download the .AppImage file to your desired location (e.g., ~/Applications/)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.7.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Run it: ./SnapLeads-3.5.7.AppImage",
  ...
  },
  {
    ...
    steps: [
      ...
      "For AppArmor: sudo aa-complain /path/to/SnapLeads-3.5.7.AppImage",
...
const installSteps: Record<OSTab, string[]> = {
  ...
  linux: [
    ...
    "Open Terminal and navigate to the download location",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.7.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Run it: ./SnapLeads-3.5.7.AppImage (or double-click if FUSE is installed)",
