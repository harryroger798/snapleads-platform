...
const DOWNLOAD_WIN = "https://f005.backblazeb2.com/file/snapleads-downloads/desktop/SnapLeads%20Setup%203.5.8.exe";
const DOWNLOAD_MAC = "https://f005.backblazeb2.com/file/snapleads-downloads/desktop/SnapLeads-3.5.8-arm64-mac.zip";
const DOWNLOAD_LINUX = "https://f005.backblazeb2.com/file/snapleads-downloads/desktop/SnapLeads-3.5.8.AppImage";
const VERSION = "3.5.8";

type OSTab = "windows" | "macos" | "linux";

const VT_SCAN_URLS: Record<OSTab, string> = {
    windows: "https://www.virustotal.com/gui/file/8bc0069e1f9b3d5157a213cccc15963a7906d1104effad3041ae3d5f7921c095",
    macos: "https://www.virustotal.com/gui/file/e6590c0f2a1609aab32d40f39a65a5a1c405e5ba2b166c689be01e1e47ed1d89",
    linux: "https://www.virustotal.com/gui/file/beac3be4887897e9ba499e5da2b10509e7ca9dacbf65417f6c24a982e1a2119a",
};
...
const bypassGuides: BypassGuide[] = [
  ...
  },
  {
    ...
    steps: [
      "Download the .AppImage file to your desired location (e.g., ~/Applications/)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.8.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Run it: ./SnapLeads-3.5.8.AppImage",
  ...
  },
  {
    ...
    steps: [
      ...
      "For AppArmor: sudo aa-complain /path/to/SnapLeads-3.5.8.AppImage",
...
const installSteps: Record<OSTab, string[]> = {
  ...
  linux: [
    ...
    "Open Terminal and navigate to the download location",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.8.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Run it: ./SnapLeads-3.5.8.AppImage (or double-click if FUSE is installed)",
