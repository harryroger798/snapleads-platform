...
const DOWNLOAD_WIN = "https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.11/SnapLeads-Setup-3.5.11.exe";
const DOWNLOAD_MAC = "https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.11/SnapLeads-3.5.11-arm64-mac.zip";
const DOWNLOAD_LINUX = "https://f005.backblazeb2.com/file/snapleads-downloads/v3.5.11/SnapLeads-3.5.11.AppImage";
const VERSION = "3.5.11";

type OSTab = "windows" | "macos" | "linux";

const VT_SCAN_URLS: Record<OSTab, string> = {
    windows: "https://www.virustotal.com/gui/file/72af67fa44c55d366cf78c6095b817964fdc8e597ddd33c7e65c4218295eb7c2",
    macos: "https://www.virustotal.com/gui/file/ab9b425f5dde814ec6ed50d68b9ec270f24b0052a830b072a2bdb513c62247a4",
    linux: "https://www.virustotal.com/gui/file/7d8e7e36fbc795aa0f11a965e1e4de4e35c7fdce45e5546929795183d0b7b030",
};
...
const bypassGuides: BypassGuide[] = [
  ...
  },
  {
    ...
    steps: [
      "Download the .AppImage file to your desired location (e.g., ~/Applications/)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.11.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "Run it: ./SnapLeads-3.5.11.AppImage",
  ...
  },
  {
    ...
    steps: [
      ...
      "For AppArmor: sudo aa-complain /path/to/SnapLeads-3.5.11.AppImage",
...
const installSteps: Record<OSTab, string[]> = {
  ...
  linux: [
    ...
    "Open Terminal and navigate to the download location",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Make it executable: chmod +x SnapLeads-3.5.11.AppImage",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "Run it: ./SnapLeads-3.5.11.AppImage (or double-click if FUSE is installed)",
